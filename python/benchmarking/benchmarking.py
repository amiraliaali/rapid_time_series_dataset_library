...
def benchmark(
    ...
    for run in range(num_runs):
        ...
        python_setup_timer = time.perf_counter()
        python_module.setup("stage")
        python_setup_duration = time.perf_counter() - python_setup_timer
        ...
        python_iteration_timer = time.perf_counter()
        run_python_batch_count = 0
        for batch in python_train_loader:
            run_python_batch_count += 1
        python_iteration_duration = time.perf_counter() - python_iteration_timer
        if run == 0:
        ...
        numpy_setup_timer = time.perf_counter()
        numpy_module.setup("stage")
        numpy_setup_duration = time.perf_counter() - numpy_setup_timer
        ...
        numpy_iteration_timer = time.perf_counter()
        run_numpy_batch_count = 0
        for batch in numpy_train_loader:
            run_numpy_batch_count += 1
        numpy_iteration_duration = time.perf_counter() - numpy_iteration_timer
        ...
        rust_setup_timer = time.perf_counter()
        rust_module.setup("stage")
        rust_setup_duration = time.perf_counter() - rust_setup_timer
        ...
        rust_iteration_timer = time.perf_counter()
        run_rust_batch_count = 0
        for batch in rust_train_loader:
            run_rust_batch_count += 1
        rust_iteration_duration = time.perf_counter() - rust_iteration_timer
        ...
        try:
            ...
            torch_setup_timer = time.perf_counter()
            torch_module.setup("stage")
            torch_setup_duration = time.perf_counter() - torch_setup_timer
            ...
            torch_iteration_timer = time.perf_counter()
            run_torch_batch_count = 0
            for batch in torch_train_loader:
                run_torch_batch_count += 1
            torch_iteration_duration = time.perf_counter() - torch_iteration_timer
            if run == 0:
